                                ...
                                <div class="footer-logo">
                                    <figure>
                                        <a href="index-2.html"><img
                                                src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/footer-logo.png"
                                                alt=""></a>
                                    </figure>
                                </div>
                                ...
                                <div class="widget-content">
                                    <div class="post">
                                        <div class="thumb"><a href="blog-detail.html"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/resource/post-thumb-1.jpg"
                                                    alt=""></a></div>
                                    ...
                                    <div class="post">
                                        <div class="thumb"><a href="blog-detail.html"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/resource/post-thumb-2.jpg"
                                                    alt=""></a></div>
                                    ...
                                    <div class="outer clearfix">
                                        <figure class="image">
                                            <a href="images/gallery/1.jpg" class="lightbox-image"
                                                title="Image Title Here"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/resource/work-thumb-1.jpg"
                                                    alt=""></a>
                                        </figure>
                                        ...
                                        <figure class="image">
                                            <a href="images/gallery/2.jpg" class="lightbox-image"
                                                title="Image Title Here"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/resource/work-thumb-2.jpg"
                                                    alt=""></a>
                                        </figure>
                                        ...
                                        <figure class="image">
                                            <a href="images/gallery/3.jpg" class="lightbox-image"
                                                title="Image Title Here"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/resource/work-thumb-3.jpg"
                                                    alt=""></a>
                                        </figure>
                                        ...
                                        <figure class="image">
                                            <a href="images/gallery/4.jpg" class="lightbox-image"
                                                title="Image Title Here"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/resource/work-thumb-4.jpg"
                                                    alt=""></a>
                                        </figure>
                                        ...
                                        <figure class="image">
                                            <a href="images/gallery/5.jpg" class="lightbox-image"
                                                title="Image Title Here"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/resource/work-thumb-5.jpg"
                                                    alt=""></a>
                                        </figure>
                                        ...
                                        <figure class="image">
                                            <a href="images/gallery/1.jpg" class="lightbox-image"
                                                title="Image Title Here"><img
                                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/mages/resource/work-thumb-6.jpg"
                                                    alt=""></a>
                                        </figure>
                                    </div>
                                </div>
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/mixitup.js"></script>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/script.js"></script>
<!-- Color Setting -->
<script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/color-settings.js"></script>
</body>
